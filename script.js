...
${this.wrapWithColor("│", "#ff8c00")} ${this.wrapWithColor(
      "Passionate and driven technology enthusiast skilled in",
      "#ffffff"
    )}
${this.wrapWithColor("│", "#ff8c00")} ${this.wrapWithColor(
      "Python, Java, JavaScript, and modern web technologies.",
      "#ffffff"
    )}
${this.wrapWithColor(
  "└─────────────────────────────────────────────────────────┘",
...
${this.wrapWithColor("⚡ Experience & AI", "#ff8c00")}
${this.wrapWithColor(
  "   Building innovative digital solutions and exploring emerging",
  "#ffffff"
)}
${this.wrapWithColor("   technologies, automation, and AI-powered products.", "#ffffff")}

${this.wrapWithColor("⚡ Passion", "#ff8c00")}
${this.wrapWithColor(
  "   Product building, tech communities, entrepreneurship, and",
  "#ffffff"
)}
${this.wrapWithColor(
  "   collaborating on meaningful projects that combine innovation",
  "#ffffff"
)}
${this.wrapWithColor(
  "   with technology.",
...
<span style="color: #00ffff;">EDUSKILLS | Full Stack Developer Intern</span>
${this.wrapWithColor(
...
• ${this.wrapWithColor("Full Stack development", "#ffa07a")} - ${this.wrapWithColor(
      "Built full-stack applications using Node.js, Express.js, HTML, CSS, and JavaScript.",
      "#ffffff"
    )}
• ${this.wrapWithColor("Responsive UI", "#ffa07a")} - ${this.wrapWithColor(
      "Developed responsive user interfaces to improve user experience.",
      "#ffffff"
    )}
• ${this.wrapWithColor("Database & API Integration", "#ffa07a")} - ${this.wrapWithColor(
      "Integrated RESTful APIs and managed SQL/Firebase databases for authentication and real-time performance.",
      "#ffffff"
    )}

${this.wrapWithColor("Technologies used:", "#00ffff")} ${this.wrapWithColor(
      "Node.js, Express.js, HTML, CSS, JavaScript, SQL, Firebase, REST APIs",
      "#87cefa"
    )}

<span style="color: #00ffff;">HIPPO CLOUD TECHNOLOGIES | Django Developer Intern</span>
${this.wrapWithColor(
  "Dec 2023 - Mar 2024 | Visakhapatnam, India",
  "#ffffff"
)}

• ${this.wrapWithColor("Django Admin Interface", "#ffa07a")} - ${this.wrapWithColor(
      "Developed a Django-based Admin Interface with full CRUD operations and role-based access control.",
      "#ffffff"
    )}
• ${this.wrapWithColor("Data Management", "#ffa07a")} - ${this.wrapWithColor(
      "Improved data management efficiency and reduced manual entry errors.",
      "#ffffff"
    )}
• ${this.wrapWithColor("Django ORM Optimization", "#ffa07a")} - ${this.wrapWithColor(
      "Designed and optimized relational data models using Django ORM for scalability and performance.",
      "#ffffff"
    )}

${this.wrapWithColor("Technologies used:", "#00ffff")} ${this.wrapWithColor(
      "Python, Django, Django ORM, SQL, Relational Databases",
      "#87cefa"
    )}`;
...
${this.wrapWithColor(
  ...
  showSkills(outputElement = this.output) {
    const skills = `<span style="color: #ffff00; font-weight: bold;">🛠️ PROGRAMMING & TOOLS</span>
...
${this.wrapWithColor("✉", "#ff8c00")}  ${this.wrapWithColor(
      ...
      '<a href="mailto:sahitsai6@gmail.com" style="color: #ffffff; text-decoration: none;">sahitsai6@gmail.com</a>',
      "#ffffff"
    )}
...
${this.wrapWithColor("🌐", "#ff8c00")}  ${this.wrapWithColor(
      ...
      '<a href="https://sahit-sai.github.io" target="_blank" style="color: #ffffff; text-decoration: none;">sahit-sai.github.io</a>',
      "#ffffff"
    )}
...
${this.wrapWithColor("⚡", "#ff8c00")}  ${this.wrapWithColor(
      ...
      '<a href="https://github.com/sahit-sai" target="_blank" style="color: #ffffff; text-decoration: none;">github.com/sahit-sai</a>',
      "#ffffff"
    )}
...
${this.wrapWithColor("💼", "#ff8c00")}  ${this.wrapWithColor(
      ...
      '<a href="https://linkedin.com/in/sahitsaipothala" target="_blank" style="color: #ffffff; text-decoration: none;">linkedin.com/in/sahitsaipothala</a>',
      "#ffffff"
    )}
...
${this.wrapWithColor("╰────────────────────────────────────────╯", "#ff8c00")}`;
  ...
  generateLinkedInCover(outputElement) {
    ...
    terminalTitle.textContent = "sahit@sai: ~/interactive-resume";
...
╚══════╝╚═╝  ╚═╝╚═╝  ╚═╝╚═════╝    ╚═╝   `;
    ...
    url.textContent = "sahit-sai.github.io";
